...
class DatabaseManager
{
    ...
    private static function connectDB(): PDO
    {
        ...
        $dbName = 'garage12';  // Nom de la base de données
        $user = 'root';  // Nom d'utilisateur défini dans docker-compose.yml
        $password = 'rootpassword';  // Mot de passe défini dans docker-compose.yml
